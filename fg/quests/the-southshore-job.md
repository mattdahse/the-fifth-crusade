...
The cell is broken, the tunnel under it is known to Mira, and — if the party thought to look —
so is the route out of Drezen that does not pass a gate. The map they take off a body in that
tunnel is what sends them to the Marchlands, and it is the reason there is a second commission.
